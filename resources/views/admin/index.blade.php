...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/templete/sneat')}}/assets/vendor/libs/apex-charts/apex-charts.css" />
  ...
  <body>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset('assets/templete/sneat')}}/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
    ...
    <!-- Vendors JS -->
    <script src="{{asset('assets/templete/sneat')}}/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="{{asset('assets/templete/sneat')}}/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="{{asset('assets/templete/sneat')}}/assets/js/dashboards-analytics.js"></script>
